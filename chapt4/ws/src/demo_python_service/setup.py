...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + "/resource", ['resource/face1.jpg']),
    ],
    install_requires=['setuptools'],
    zip_safe=True,
    maintainer='edward',
    maintainer_email='edward.elric.5553@gmail.com',
    description='TODO: Package description',
    license='Apache-2.0',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'learn_face_detector = demo_python_service.learn_face_detect:main',
